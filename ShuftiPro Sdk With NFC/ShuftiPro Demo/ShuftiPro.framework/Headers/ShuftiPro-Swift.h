...
@interface NFCCameraVc : UIViewController <AVCaptureVideoDataOutputSampleBufferDelegate>
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified cameraView;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified titleView;
...
SWIFT_CLASS("_TtC9ShuftiPro14PassportReader") SWIFT_AVAILABILITY(ios,introduced=13)
...
@property (nonatomic, weak) IBOutlet WKWebView * _Null_unspecified privacyPolicyWebView;
